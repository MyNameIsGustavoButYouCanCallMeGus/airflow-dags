...
select
        ...
        date(t2.guarantee_date)  as d4_guarantee_date,
        t2.chieffname            as d4_chieffname,
        t2.agreement             as d4_agreement,
        date(t2.created)         as d4_created,
...
with DAG(
    dag_id="sync_mysql_to_clickhouse_dict3_flat_serzhan",
